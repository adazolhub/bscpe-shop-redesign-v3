                    ...
                    <div className="grid grid-cols-1 row-start-1 row-end-4 gap-4 px-2 grid-flow-dense md:grid-cols-2 xl:grid-cols-3 place-items-center">
                        {
                            Array.from(new Array(24)).map((_, index) => (
                                <div
                                    key={index}
                                    className="flex w-full min-w-full overflow-hidden transition-all bg-gray-100 border border-transparent rounded-lg hover:bg-gray-50 hover:shadow-lg h-60 md:h-90 hover:border-gray-300 group">
                                    <div className="flex flex-col justify-between w-full h-full gap-2 p-4 ">
                                        ...
                                        <div className="flex flex-col gap-2">
                                            <div>
                                                ...
                                                <p className="text-xs line-through text-gray-500/70">P640.00</p>

                                            </div>
                                            <div className="inline-flex gap-4 flex-nowrap">
                                                <button className="px-4 py-1 text-sm text-white bg-gray-700 border rounded-md whitespace-nowrap border-gray-400/50">Buy now</button>
                                                <button className="px-4 py-1 text-sm text-gray-500 border rounded-md whitespace-nowrap border-gray-400/50">Add to Cart</button>
                                            </div>
                                        </div>

                                    </div>
                                    <div className="h-full bg-gray-800 w-60">
                                        <img className="object-cover w-full h-full transition-all opacity-40 group-hover:opacity-80" src="https://images.unsplash.com/photo-1578681994506-b8f463449011?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80" alt="" />
                                    </div>
                                </div>
                            )
                            )
                    ...
                    <div className="grid grid-cols-2 row-start-1 row-end-4 gap-4 px-2 grid-flow-dense sm:grid-cols-3 xl:grid-cols-4 place-items-center">
                        {
                            Array.from(new Array(24)).map((_, index) => (
                                <div
                                    key={index}
                                    className="relative grid w-full min-w-full overflow-hidden transition-all rounded-lg h-60 place-content-center hover:shadow-md group">

                                    <img className="object-cover w-full h-full transition-all opacity-100 hover:opacity-70" src="https://images.unsplash.com/photo-1578681994506-b8f463449011?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80" alt="" />
                                    ...
                                    <div className="absolute top-0 p-2">
                                        <p className="font-bold text-yellow-600">PHP 300.00  <span className="text-xs font-thin text-gray-300/70">Save 70%</span></p>
                                        <p className="text-xs font-thin line-through text-gray-300/70">P640.00</p>

                                    </div>
                                    <div className="absolute bottom-0 w-[calc(100%-1em)]">
                                        <h3 className="px-2 font-medium text-white">Shirt for men</h3>
                                        <p className="px-2 mb-4 text-xs text-gray-300/70">Lorem ipsum dolor sit amet.</p>
                                        <div className="flex w-full gap-4 mx-2 mb-2 flex-nowrap">
                                            <button className="w-full px-4 py-1 text-sm text-gray-100 border rounded-md whitespace-nowrap border-gray-400/50 bg-gray-500/10 backdrop-blur-lg">Add to Cart</button>
                                            <button className="p-1 px-2 text-sm text-gray-100 border rounded-md whitespace-nowrap border-gray-400/50 bg-gray-500/10 w-fit backdrop-blur-lg">♥</button>
