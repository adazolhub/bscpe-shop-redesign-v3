function Sidebar (){
    ...
    return(
        ...
        <div className="fixed min-h-screen top-0 left-0 min-w-full bg-gray-800/50 backdrop-blur-[2px] cursor-pointer">

        <div className="close fixed top-4 right-4 hover:bg-slate-400">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M19 6.41L17.59 5L12 10.59L6.41 5L5 6.41L10.59 12L5 17.59L6.41 19L12 13.41L17.59 19L19 17.59L13.41 12L19 6.41Z" fill="#FAFAFA"/>
            </svg>
        </div>
        </div>
         <div className="fixed min-h-screen top-0 flex flex-col justify-between p-4 bg-white shadow-md min-w-[65%] select-none rounded-r-lg">
            <div className="title flex flex-col gap-16 text-gray-500">
            ...
            <div>
                <ul className="flex flex-col gap-1">
                    <li className="flex gap-6 whitespace-nowrap items-center justify-between hover:bg-slate-100 py-4 px-2 rounded-md cursor-pointer group">
                        <div className="flex items-center gap-6">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M16 12L10 6L8.59 7.41L13.17 12L8.59 16.59L10 18L16 12Z" fill="currentColor"/>
                            </svg>
            ...
            <ul className="flex flex-col gap-4">
                    ...
                    <li className="flex gap-6 whitespace-nowrap items-center justify-between hover:bg-slate-100 py-4 px-2 rounded-md cursor-pointer group">
                        ...
                        <div className="icon">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11 15H13V17H11V15ZM11 7H13V13H11V7ZM11.99 2C6.47 2 2 6.48 2 12C2 17.52 6.47 22 11.99 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 11.99 2ZM12 20C7.58 20 4 16.42 4 12C4 7.58 7.58 4 12 4C16.42 4 20 7.58 20 12C20 16.42 16.42 20 12 20Z" fill="currentColor"/>
                            </svg>
