                ...
                <div className="flex flex-col justify-between items-center h-[calc(100vh-3em)] w-[calc(100vw-2em)] md:w-[calc(90%-2em)] lg:max-w-md mx-auto">
                    ...
                    <div className="flex flex-col w-full p-4 mx-auto rounded-lg">
                        ...
                        <form onSubmit={register} className="flex flex-col gap-2">
                            ...
                            <input type="email" className="text-field" name="username" placeholder="Email" onChange={(event) => {
                                setEmail(event.target.value)
                            }} />
                            <input type="text" className="text-field" name="name" placeholder="Name" onChange={(event) => {
                                setUsername(event.target.value)
                            }} />
                            <input type="password" className="text-field" name="password" placeholder="Password" onChange={(event) => {
                                setPassword(event.target.value)
                            }} />
                            <input type="password" className="text-field" name="confirm-password" placeholder="Confirm password" onChange={(event) => {
